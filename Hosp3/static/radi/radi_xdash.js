...
function call() {
    $.ajax({
        url: "../xray_pats_chart_1_this_year/",
        type: "GET",
        data: {},
        method: "GET",
        success: function (res) {
            console.log(res)
            //console.log(res[0])
            console.log(res[0]['monthly'])
            statsValues1(res[0]);
            chart1(res[0]['monthly']);
        },
        complete: function() {
            $.ajax({
                url: "../xray_exams_chart_1_this_year/",
                type: "GET",
                data: {},
                method: "GET",
                success: function (res) {
...
function chart1(data) {
    ...
    var chart_p = new CanvasJS.Chart("pat-bar-chart", {
        title:{
            text: "XRAY Monthly New Patients Statistics"
        },
        data: [{
            type: "column",
            dataPoints: [],
...
function chart2(data_month2) {
    ...
    var chart_e = new CanvasJS.Chart("exam-bar-chart", {
        title:{
            text: "XRAY Monthly New Exams Statistics"
        },
        data: [{
            type: "column",
            dataPoints: [],
